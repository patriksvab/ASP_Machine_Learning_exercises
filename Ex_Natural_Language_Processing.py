...
df2 = pd.DataFrame({"Decade": decades, "Words per Job Ad": job_ads_df["Words per Job Ad"]})
...
count = CountVectorizer(stop_words=_stopwords_all, tokenizer=tokenize_and_stem_ger)
